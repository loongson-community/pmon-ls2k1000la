...
/*
 * |-----------------------------------------------------------|
 * | Copyright (c) 1992, 1991, 1990 LOONGARCH Computer Systems, Inc.|
 * | LOONGARCH Computer Systems, Inc. grants reproduction and use   |
...
/*
 * The file indirect table in the loongarch loader is known as an array of FITs.
...
stMember	scNil	ordinal		---	(if member of enum)
	(read thinks the case below has a bit, not byte, offset.)
