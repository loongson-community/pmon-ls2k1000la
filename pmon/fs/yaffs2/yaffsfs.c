...
#endif
        printf("part_size=0x%08x,open_size=0x%08x,part_offset=0x%08x,open_offset=0x%08x\n",info->part_size,priv->open_size,info->part_offset,priv->open_offset);
...
int yaffs_mount(const char *path)
{
	...
	T(YAFFS_TRACE_ALWAYS,("yaffs2: Mounting %s\n",path));
