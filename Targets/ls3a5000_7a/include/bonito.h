...
#define BONITO(x)	*(volatile unsigned int *)(PHYS_TO_UNCACHED(0x1fe00000)+(x))
#endif /* __ASSEMBLER__ */
...
#define GS3_UART0_BASE PHYS_TO_UNCACHED(0x1fe001e0)
#define GS3_UART1_BASE PHYS_TO_UNCACHED(0x1fe001e8)
#define GS3_UART_BASE   GS3_UART0_BASE
#ifdef LS3_HT
#define COM1_BASE_ADDR	PHYS_TO_UNCACHED(0x180003f8)
#define COM2_BASE_ADDR	PHYS_TO_UNCACHED(0x180002f8)
#endif
#ifndef COM3_BASE_ADDR
#define COM3_BASE_ADDR	PHYS_TO_UNCACHED(0x1ff003f8)
#endif
...
#define MC_INFO_SIZE		(DIMM_OFFS_DDR_VREF + MC_CHANNEL_DDR_VREF_WIDTH)
...
#define PCI_MEM_SPACE_PCI_BASE		0x20000000
...
#define BONITO_BOOT_BASE		0x1c000000
...
#define BONITO_PCILO_SIZE		0x60000000
#define BONITO_PCILO_TOP		(BONITO_PCILO0_BASE+BONITO_PCILO_SIZE-1)
#define BONITO_PCILO0_BASE		0x20000000
...
#define BONITO_PCICFG0_BASE_VA		PHYS_TO_UNCACHED(0xefdfe000000)	//0xba000000
#define BONITO_PCICFG1_BASE_VA		PHYS_TO_UNCACHED(0xefdff000000)	//0xbb000000
...
#define BONITO_BONPONCFG_ROMBOOT_CPURESE	(0x3<<BONITO_BONPONCFG_ROMBOOT_SHIFT)
...
#define BONITO_PCITOPHYS(WIN,ADDR,CFG)		((((ADDR) & (~(BONITO_PCIMEMBASECFG_MASK))) &	\
...
#ifdef BOARD_3C5000L_2W_V01
#define MPS_ADDR	(0x40 << 1)
#else
#define MPS_ADDR	(0x4b << 1)
#endif
...
#endif
#define DVFS_RAM_SIZE	2	//2M at 0xee000000
#define LOW_VOL_ADJUST	5	//LOW_VOL = 850 + N * 10 mV
#endif /* _BONITO_H_ */
