...
#define GMAC0_MAC_REG_ADDR      PHYS_TO_UNCACHED((*(volatile unsigned int *)(PHYS_TO_UNCACHED(0xefdfe000000) | (0 << 16) | (3 << 11) | (0 << 8) | 0x10)) & (~0xf) | 0xe0000000000)
#define GMAC1_MAC_REG_ADDR      PHYS_TO_UNCACHED((*(volatile unsigned int *)(PHYS_TO_UNCACHED(0xefdfe000000) | (0 << 16) | (3 << 11) | (1 << 8) | 0x10)) & (~0xf) | 0xe0000000000)
