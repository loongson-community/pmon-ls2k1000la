...
#define GMAC0_MAC_REG	((*(volatile unsigned int *)(PHYS_TO_UNCACHED(BONITO_PCICFG0_BASE_VA) | (0 << 16) | (3 << 11) | (0 << 8) | 0x10)))
#define GMAC1_MAC_REG	((*(volatile unsigned int *)(PHYS_TO_UNCACHED(BONITO_PCICFG0_BASE_VA) | (0 << 16) | (3 << 11) | (1 << 8) | 0x10)))
#define GMAC0_MAC_REG_ADDR	PHYS_TO_UNCACHED((GMAC0_MAC_REG & (~0xf)))
#define GMAC1_MAC_REG_ADDR	PHYS_TO_UNCACHED((GMAC1_MAC_REG & (~0xf)))
/*--------------------------------------------*/
