...
typedef struct SCSI_cmd_block{
	...
	unsigned int		datalen;					/* Total data length	*/
	...
	unsigned int		sensedatalen;			/* Sense data len			*/
	unsigned char		sensecmd[6];			/* Sense command			*/
	unsigned int		contr_stat;				/* Controller Status	*/
	unsigned int		trans_bytes;			/* tranfered bytes		*/
