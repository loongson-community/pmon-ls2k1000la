...
#undef	LOONGARCH_IO_BASE
//#define	LOONGARCH_IO_BASE	(0xbfd00000)
#define	LOONGARCH_IO_BASE	BONITO_PCIIO_BASE_VA
...
#undef	read_port
#undef	write_port
#define	read_port(x)	 (*(volatile unsigned char *)(LOONGARCH_IO_BASE | x))
#define	write_port(x, y) (*(volatile unsigned char *)(LOONGARCH_IO_BASE | x) = y)	
