...
//------------------------------------------
#define CKSEG1ADDR(a)   PHYS_TO_UNCACHED(a)
...
#define LS2H_DMA_ORDER_REG				0x1fe00c00 //(LS2H_CHIP_CFG_REG_BASE + 0x0100)
#define LS2H_NAND_REG_BASE				0x1fe26000
...
#define	_NAND_BASE	PHYS_TO_UNCACHED(LS2H_NAND_REG_BASE)
...
static void ls2k_nand_init_info(struct ls2k_nand_info *info)
{
	...
	writel(0x88442200, REG(NAND_CS_RDY_REG));
